          ...
          <div className="flex-1 min-w-0 flex flex-col min-h-0 overflow-hidden">
            ...
            <div className="flex items-center gap-1.5 mt-2 flex-wrap overflow-hidden">
              ...
              {entry?.openingDay && entry?.openingShow && (
                <span className="text-xs px-1.5 py-0.5 rounded flex-shrink-0" style={{ background: 'rgba(255,107,107,0.15)', color: 'var(--color-accent)', fontFamily: 'var(--font-caption)' }}>FDFS</span>
              )}
              {entry?.openingDay && !entry?.openingShow && (
                <span className="text-xs px-1.5 py-0.5 rounded flex-shrink-0" style={{ background: 'rgba(34,197,94,0.15)', color: 'var(--color-success)', fontFamily: 'var(--font-caption)' }}>Opening Day</span>
              )}
            </div>
          </div>
        </div>
